...
To work on Hilbert, you'll need to install a newer version of Python. After installation, open a terminal in the root of the repository and create a virtual environment:
```bash
python -m venv venv
```
```bash
...
We are committed to providing a welcoming and inclusive experience for everyone. We expect all participants to adhere to our Code of Conduct. Please read [Code of Conduct](https://github.com/TudorOrban/Hilbert/blob/main/CODE_OF_CONDUCT.md) to understand what behaviors will not be tolerated.
...
1. Go to the [Issues](https://github.com/TudorOrban/Hilbert/issues) page.
...
### Feature Requests
We welcome suggestions for new features. If there's something you'd like to see added to Hilbert, please open a new issue.
